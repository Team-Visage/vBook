  ...
  _createClass(PostPage, [{
    ...
    value: function likePost() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "form",
          { method: "post", onSubmit: this.subitForm.bind(this), action: "/like?post[id]=" + this.props.post.id },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            "button",
    ...
    key: "subitForm",
    value: function subitForm(e) {
      e.preventDefault();
      return fetch("api/like?post[id]=" + this.props.post.id);
    }
  }, {
    key: "commentSubmit",
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            { id: "comment" + this.props.post.id, type: "Submit", onClick: function onClick() {
                return _this3.setState({ newComment: true });
              } },
            "New Comment"
          )
        );
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-0072aaec37cbe48f8ccd.js.map