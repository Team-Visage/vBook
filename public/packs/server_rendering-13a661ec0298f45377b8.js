  ...
  _createClass(PostPage, [{
    ...
    value: function modifyPost() {
      ...
      if (this.state.isPostOwner) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            "form",
            { method: "post", action: "/posts/destroy?post[id]=" + this.props.post.id },
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              "button",
              { id: "deletePost" },
              "Delete"
    ...
    value: function showPostEdit() {
      if (this.state.editingActive) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "form",
          { method: "post", action: "/posts/" + this.props.post.id + "/edit?['message']=" + this.props.post.message },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("textarea", { defaultValue: this.props.post.message }),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            "button",
            null,
            "Submit"
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-13a661ec0298f45377b8.js.map