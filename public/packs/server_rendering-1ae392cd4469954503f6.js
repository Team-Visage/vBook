...
throw new Error("Module build failed: SyntaxError: Unexpected token (76:86)\n\n  74 |     return(\n  75 |       <div>\n> 76 |         <form method='post' action={`/like?post[id]=${this.props.post.id}`} onSubit={() this.handleFormSubmit(this)}>\n     |                                                                                       ^\n  77 |           <button id={`like${this.props.post.id}`} type='Submit'>Like</button>\n  78 |         </form>\n  79 |       </div>\n");
...
var emptyObject = __webpack_require__(/*! fbjs/lib/emptyObject */ 5);
var hyphenateStyleName = __webpack_require__(/*! fbjs/lib/hyphenateStyleName */ 8);
var camelizeStyleName = __webpack_require__(/*! fbjs/lib/camelizeStyleName */ 9);
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-1ae392cd4469954503f6.js.map