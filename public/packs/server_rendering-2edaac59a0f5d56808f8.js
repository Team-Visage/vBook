  ...
  _createClass(PostPage, [{
    ...
    value: function modifyPost() {
      ...
      if (this.state.isPostOwner) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            "form",
            { method: "post", action: "/posts/destroy" },
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              "button",
              { id: "deletePost" },
              "Delete"
    ...
    value: function showPostEdit() {
      if (this.state.editingActive) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "form",
          { method: "post", action: "/posts/" + this.props.post.id + "/edit/post?['message']=" + this.props.post.message },
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-2edaac59a0f5d56808f8.js.map