...
throw new Error("Module build failed: SyntaxError: Unexpected token, expected , (95:2)\n\n  93 |     }).then((response) => console.log(response.text())\n  94 |     .then(console.log('complete'))\n> 95 |   }\n     |   ^\n  96 | \n  97 |   commentSubmit(){\n  98 |     var id = this.props.post.id\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-8a6efcd8116cd59544d8.js.map